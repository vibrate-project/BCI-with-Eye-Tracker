...
#     Negative.append(Data[p][0][s][0]+Data[p][0][s][1])
#     Positive.append(Data[p][1][s][0]+Data[p][1][s][1])
# N=len(Negative[0])
...
def FindWeights(segment):
    ...
    for i in range(NSteps):
        ...
        DirName='MiddleAdaptive/Segment'+str(segment)
        MainDir=os.getcwd()    
...
# vals=[0,-1,-2,2,-3,-4,4,-6]
# for v in vals:
    # DirName='Middle'+str(v)
    # MainDir=os.getcwd()    
    # os.chdir('./'+DirName)
    # i=15
...
for p in range(NPeople):
    ...
    Positive.append(Data[p][1][s][0]+Data[p][1][s][1])
N=len(Negative[0])
DirName='MiddleAdaptive/Segment'+str(s)
MainDir=os.getcwd()    
os.chdir('./'+DirName)
i=10
with open('Weights'+str(i)+'.pkl', 'rb') as f:
